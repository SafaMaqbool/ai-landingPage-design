  ...
  return (
    ...
    >
      ...
      <div className="absolute h-[344px] w-[344px]  md:h-[580px] md:w-[580px] border opacity-20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        <div className="absolute h-5 w-5 top-1/2 -translate-x-1/2 -translate-y-1/2 left-full border border-white rounded-full inline-flex items-center justify-center">
      ...
      <div className="container relative mt-16">
        ...
        <p className="text-lg md:text-xl max-w-xl mx-auto text-white/70 mt-5 text-center ">
          Elevate your site's visiblity effortlessly with AI, where smart
